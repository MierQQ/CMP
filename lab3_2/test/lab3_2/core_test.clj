...
(deftest subfilter-test
  (testing "filter test 1"
    (is (= (filter pred col) (my-subfilter 1 pred col))))
  (testing "filter test 2"
    (is (= (filter pred col) (my-subfilter 2 pred col))))
  (testing "filter test 3"
    (is (= (filter pred col) (my-subfilter 3 pred col))))
  (testing "filter test 4"
    (is (= (filter pred col) (my-subfilter 4 pred col)))))
